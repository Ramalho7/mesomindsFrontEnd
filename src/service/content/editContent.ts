...
async function EditContentApi(payload: EditContentPayload): Promise<EditContentResponse> {
    ...
    try {
        const response = await api.put<EditContentResponse>(`/api/conteudos/${id}`, requestBody)
