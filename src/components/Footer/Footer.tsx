...
export default function Footer() {
    ...
    return (
        <footer className="flex flex-col min-h-[31.25rem] mt-auto sm:flex sm:flex-col sm:justify-between border-solid border-t-2 border-accent p-5 flex-grow">
            <div className="sm:flex sm:gap-[6.25rem] md:gap-[2.5rem]">
                ...
                <div className="flex flex-row gap-2 mt-7 sm:mt-0 sm:gap-0 sm:max-h-[31.25rem] md:max-h-[11.25rem] md:gap-4">
                    ...
                    <img src={math} className="w-[50%] sm:w-full" alt="Imagem sobre matemática" />
                </div>
            </div>
            <div className="text-center text-sm text-gray-500 p-5 border-t border-gray-300 mt-auto">
