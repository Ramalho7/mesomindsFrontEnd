    ...
    return (
        <div className="min-h-screen flex items-center justify-center">
            ...
            >
                ...
                <div>
                    ...
                    <div className="relative">
                        ...
                        >
                            ...
                            <div className="sr-only">{showPassword ? "Ocultar" : "Mostrar"} senha</div>
                        </button>
                    </div>
                    {errors.password && (
                        <p className="text-destructive-foreground text-sm mt-1 mb-1">
                ...
                {showRegisterLink && (
                    <Link to={"/register"} search={{ redirect: "/perfil" }} className="flex items-center mt-4">
                        Ainda não possui conta? <span className="underline decoration-accent">Crie agora.</span>
